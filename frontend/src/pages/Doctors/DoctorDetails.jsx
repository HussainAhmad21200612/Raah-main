     ...
     <div className="md:col-span-2">
      ...
      <div className="mt-[50px] border-b border-solid border-[#0066ff34]">
       ...
       <div className="mt-[50px]">
        {tab=='about' && <DoctorAbout name={name} experiences={experiences} qualifications={qualifications} about={about} />}
        {tab=='feedback' && <Feedback reviews={reviews} totalRating={totalRating}/>}
       </div>

        </div>
          <div>
            <SidePanel doctorId={docData?.data?._id} ticketPrice={ticketPrice} timeSlots={timeSlots}/>
          </div>
